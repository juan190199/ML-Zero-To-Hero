...
class LDA(object):
    """
    Linear Discriminant Analysis is a classifier algorithm with a linear decision boundary,
    ...
    Attributes
    -----------
    * coef_: ndarray of shape (rank, n_classes - 1)
    ...
    * scalings_: ndarray of shape (rank, n_classes - 1)
    ...
    * xbar_: ndarray of shape (n_features,)
    ...
    def _decision_function(self, X):
        ...
        :return: ndarray of shape (n_samples, n_classes) or (n_samples,)
    ...
    #
    #     :param X_test: ndarray of shape (n_samples, n_features) -- Input data
